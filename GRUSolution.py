...
GRUModel.add(GRU(128))

#return_sequencnes = True... all timesteps.
#LSTMModel.add(GRU(32, return_sequences=True))
...
TestScores = GRUModel.predict(X_test)
TestScores2 = GRUModel.predict_classes(X_test)

accuracy_score(test_labels, TestScores2)
